...
export class Universe {
    ...
    add_pattern(pattern, row_center, col_center) {
        wasm.universe_add_pattern(this.__wbg_ptr, pattern, row_center, col_center);
    }
    clear() {
     ...
     */
    ncols() {
        const ret = wasm.universe_ncols(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} nrows
     * @param {number} ncols
     * @param {Cell | null} [cell_state]
     * @returns {Universe}
     */
     ...
     */
    nrows() {
        const ret = wasm.universe_nrows(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} p
     ...
     */
    state() {
        const ret = wasm.universe_state(this.__wbg_ptr);
        return ret >>> 0;
    }
    tick() {
